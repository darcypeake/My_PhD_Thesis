...
\end{feynman}
\end{tikzpicture}
\caption{Diagrammatic representation of a $2\to m$ hard scattering process, $\mathcal{H}$, with an additional soft or collinear emission $p_i$. \question{Shall I make this bigger?}}
