...
re-clustering step, we start by reviewing the $e^+e^-$ variants before
turning to DIS in Secs.~\ref{sec:exclktalgo} and \ref{sec:camdis}. The
$k_t$ variant (Durham) was introduced in
...
\subsection{Jet Algorithms for Hadronic Collisions}
\subsubsection{Generalised inclusive $k_t$-algorithms for $pp$ and DIS}
\label{sec:gen-kt}
