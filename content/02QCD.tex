...
The Feynman rules extracted from the full QCD Lagrangian are shown in Figs.~\ref{fig:QCD-Propagator-Rules} and~\ref{fig:QCD-Vertex-Rules}. For brevity, the ghost Feynman rules are omitted, as they are not required for the calculations presented in this thesis.{\color{red} (Think about whether to say full or not as think it's actually only from the classical part.)}
