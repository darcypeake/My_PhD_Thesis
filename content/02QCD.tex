...
\begin{itemize}
	...
	include \textsc{PanScales} and \textsc{Pythia}. Current parton showers achieve
	next--to--leading logarithmic (NLL) accuracy for a broad class of observables, with
	ongoing work aimed at extending this to higher logarithmic accuracy. {\color{red} Numerical? Pythia? Broad class of observables?}
	...
	resummation frameworks such as \textsc{CAESAR} and \textsc{ARES} fall into this
	category. For $e^+e^-$ observables, resummation is known up to next--to--next--to--leading
	logarithmic (NNLL) accuracy, while hadronic observables are currently known up to NLL.
