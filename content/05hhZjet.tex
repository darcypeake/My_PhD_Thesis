...
that the NNLL master formula takes the same structure as the
$e^+e^-\to3$-jet result of Ref.~\cite{Arpino:2019ozn}, with the individual
components being different. What genuinely differs
...
The framework established here provides the basis for NNLL resummation of a broad class of observables in hadronic collisions.
The validation of $h_{10}$ presented in this chapter
