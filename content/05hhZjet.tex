...
which is a way of parameterising the multiple emissions? Is it all unnecessary and should
I just reference the Sudakov paper?}
...
\ndp{This is the most crucial bit to explain properly in this chapter - I am trying to validate
why it is okay to use the $hh\to H+$ jet hard function.}
...
physical hard function for $hh\to Z+\mathrm{jet}$, but rather to validate
...
\todo{Work out if we can write these in a more compact expression.}
...
the validation I did was OK - can I confirm this is accurate.}
 \ABquestion{Also, am I showing too much that the work is 
incomplete?}
