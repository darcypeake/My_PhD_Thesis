...
Since $Z+\mathrm{jet}$ and $H+\mathrm{jet}$ production have the same
coloured-parton configuration, we may use the one-loop amplitude for
$hh\to H+\mathrm{jet}$ given explicitly in Ref.~\cite{Ravindran:2002dc}. 
