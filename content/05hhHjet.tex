...
virtual corrections are not  publicly available, \add{not true, add in what A Banfi said.} we use the
results of $hh\to H $+ jet from Ref.~\cite{Ravindran:2002dc}.
 The
calculation for the $q\bar{q}\to Hg$ channel is carried out in
...
NNLL\footnote{Note that $h_{22}$ actually enters at NLL$'$.}: $\mathcal{C}^{(2)}_1$
