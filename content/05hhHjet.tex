...
$\mathcal{C}_n^{(m)}(\{p\},M,\mu_R)$ are expressed in terms of the hard, beam, jet,
and soft functions and are dimensionless. They depend on the born momenta, the invariant mass of the $Z$-boson and the renormalisation scale. These are functions which occur in SCET where
...
\begin{align}
    &\mathcal{I}_{\kappa_1 k,n}^{(m)}(z,\lambda_F,\lambda_a) =
...
\begin{subequations}
\begin{align}
    &\mathcal{I}_{\kappa_1,-1}^{(m)}(z,\lambda_F,\lambda_a) =
    \mathcal{I}_{\kappa_1,-1}^{(m)}(z,\lambda_F)
...
We suppress the argument on the coefficients $\mathcal{C}_n^{(m)}$ and the functions for brevity in the following.
...
\begin{equation}
\label{eq:C11}
    \mathcal{C}_1^{(1)}=\frac{B_{\kappa_1,1}^{(1)}(x_1,\mu_R,\mu_F,\lambda_1)}{f_i(x_1,\mu_F)}+\frac{B_{\kappa_2,1}^{(1)}(x_2,\mu_R,\mu_F,\lambda_2)}{f_j(x_2,\mu_F)}+
...
\begin{equation}
	\mathcal{C}^{(2)}_3=\frac{B_{\kappa_1,3}^{(2)}(x_1,\mu_R,\mu_F,\lambda_1)}{f_i(x_1,\mu_F)}+\frac{B_{\kappa_2,3}^{(2)}(x_2,\mu_R,\mu_F,\lambda_2)}{f_j(x_2,\mu_F)}+
