...
the partons and depends on the normalised vectors $\hat{p}_\ell=p_\ell/Q_\ell$.
...
\end{align}
\end{subequations}
and analogously for $\mathcal{I}_{\kappa_2 k,n}^{(m)}(z,\lambda_F,\lambda_2)$. The
...
\end{align}
\end{subequations}
and analogously for $\mathcal{I}_{\kappa_2 k,-1}^{(m)}$.
...
\begin{equation}
    ...
    +\widehat{S}^{(2)}_{\kappa,3}\!\left(\{\widehat{q}_\ell\},\lambda_s\right)\,
\end{equation}
...
\begin{equation}
\label{eq:C10}
    \mathcal{C}_0^{(1)}=\frac{B_{i,0}^{(1)}(x_1,\mu_R,\mu_F,\lambda_1)}{f_i(x_1,\mu_F)}+\frac{B_{j,0}^{(1)}(x_2,\mu_R,\mu_F,\lambda_2)}{f_j(x_2,\mu_F)}+
...
\begin{equation}
\begin{aligned}
   & \mathcal{C}_{-1}^{(1)}=H^{(1)}_{\rm SCET}\,+\frac{B_{\kappa_1,-1}^{(1)}(x_1,\mu_R,\mu_F,\lambda_1)}{f_i(x_1,\mu_F)}+\frac{B_{\kappa_2,-1}^{(1)}(x_2,\mu_R,\mu_F,\lambda_2)}{f_j(x_2,\mu_F)}\\
    &\qquad\qquad+J_{\kappa_3,-1}^{(1)}(\lambda_c)
    +\widehat{S}^{(1)}_{\kappa,-1}\!\left(\{\widehat{q}_\ell\},\lambda_s\right)\,.
\end{aligned}
\end{equation}
where 
