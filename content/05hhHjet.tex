...
\begin{subequations}
\begin{align}
    J_{\ell=3,-1}^{(m)}(\lambda_3) &=
    J_{\ell=3,-1}^{(m)}+\sum_{n=0}^{2m-1}J_{\ell=3,n}^{(m)}\,\frac{\ln^{n+1}\!\lambda_3}{n+1}\,, \\
...
\begin{equation}
\label{eq:C11}
    \mathcal{C}_1^{(1)}(\{p\},M,\mu_R)=\frac{B_{i;\ell=1,1}^{(1)}(x_1,\mu_R,\mu_F,\lambda_1)}{f_i(x_1,\mu_F)}+\frac{B_{j;\ell=2,1}^{(1)}(x_2,\mu_R,\mu_F,\lambda_2)}{f_j(x_2,\mu_F)}+
...
\begin{equation}
\begin{aligned}
    \mathcal{C}_{-1}^{(1)}&(\{p\},M,\mu_R)=H^{(1)}_{\rm SCET}\,+\frac{B_{i;\ell=1,-1}^{(1)}(x_1,\mu_R,\mu_F,\lambda_1)}{f_i(x_1,\mu_F)}+\frac{B_{j;\ell=2,-1}^{(1)}(x_2,\mu_R,\mu_F,\lambda_2)}{f_j(x_2,\mu_F)}\\
    &\qquad\qquad+J_{\ell=3,-1}^{(1)}(\lambda_c)
    +\widehat{S}^{(1)}_{\kappa,-1}\!\left(\{\widehat{q}_\ell\},\lambda_s\right)\,.
\end{aligned}
\end{equation}
where 
