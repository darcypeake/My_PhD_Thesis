...
\newcommand{\Vsc}[1]{V_{\mathrm{sc}}(\{\tilde{p}\},#1)}
...
\newcommand{\ptjv}{p_{\mathrm t,veto}}
\newcommand{\cF}{{\cal F}}
\newcommand{\cO}[1]{{\cal O}\left(#1\right)}
\newcommand{\NNLL}{\text{NNLL}}
\newcommand{\eff}{\epsilon}
\newcommand{\ee}{e^+e^-}
\newcommand{\M}{$\mathrm{Milan}$}
\newcommand{\fullF}{\mathcal{F}}
\newcommand{\FNLL}{\mathcal{F}_{\mathrm{NLL}}}
\newcommand{\FNNLL}{\mathcal{F}_{\mathrm{NNLL}}}
\newcommand{\nn}{\nonumber}
\newcommand{\qT}{q_T}
\newcommand{\sgnsinphii}{\frac{\sin\phi_i}{|\sin\phi_i|}}

\newcommand{\Vwa}[1]{V_{\mathrm{wa}}(\{\tilde{p}\},#1)}
\newcommand{\Vfull}[1]{V(\{\tilde{p}\},#1)}
\newcommand{\Vhc}[1]{V_{\mathrm{hc}}(\{\tilde{p}\},#1)}
\newcommand{\Vr}{V_{r}}
...
\newcommand{\scomment}[3][red]{\textbf{\color{#1}[#2]$_\text{#3}$}}

\newcommand{\sfr}[1]{\scomment[lightblue]{#1}{SFR}}
\newcommand{\ak }[1]{\scomment[teal]{#1}{AK}}
\newcommand{\mvb}[1]{\scomment[purple]{#1}{MVB}}
\newcommand{\ndp}[1]{\scomment[orange]{#1}{DP}}

%Comment commands 
\newcommand{\ABquestion}[1]{\textcolor{red}{\textbf{A.B. Question:} #1}}
\newcommand{\question}[1]{\textcolor{purple}{\textbf{Question:} #1}}
\newcommand{\add}[1]{\textcolor{blue}{\textbf{Add in:} #1}}
\newcommand{\done}[1]{\textcolor{RoyalBlue}{\textbf{Draft completed:} #1}}
\newcommand{\reference}[1]{\textcolor{orange}{\textbf{Reference used:} #1}}
\newcommand{\todo}[1]{\textcolor{webgreen}{\textbf{To do:} #1}}
\usepackage{placeins}

%ARES project commands
\newcommand{\dZ}{\mathrm{d}{\mathcal{Z}}[\{R'_{\mathrm{NLL}, \ell_i}, \{k_i\}\}]}
...
\newcommand{\ydis}{\ensuremath{y_{\mathrm{DIS}}}}
...
\newcommand\PYTHIAn{\texttt{Pythia~\!\!8.3}\xspace}
\newcommand\POWHEG{\texttt{POWHEG}}
\newcommand\POWHEGBOX{\texttt{POWHEG-BOX}\xspace}
\newcommand\POWHEGBOXVTWO{\texttt{POWHEG-BOX-V2}\xspace}
\newcommand\RES{\texttt{POWHEG-BOX-RES}\xspace}
\newcommand\OL{\texttt{OpenLoops}\xspace}
\newcommand\ggfl{\texttt{gg4l}\xspace}
...
\usepackage{inconsolata} % or \usepackage[scaled=0.85]{beramono}

\definecolor{codebg}{HTML}{F8F8F8}      % light grey background
\definecolor{codeframe}{HTML}{CCCCCC}   % light grey frame
\definecolor{codekw}{HTML}{0055AA}      % blue - keywords
\definecolor{codecomment}{HTML}{5C8A5C} % muted green - comments
\definecolor{codestring}{HTML}{AA3300}  % dark orange - strings
\definecolor{codenumber}{HTML}{999999}  % light grey - line numbers
\definecolor{codeident}{HTML}{1A1A1A}   % near-black - main text
\definecolor{codetype}{HTML}{007070}    % teal - types

\lstset{
  backgroundcolor=\color{codebg},
  basicstyle=\ttfamily\footnotesize\color{codeident}\linespread{1}\selectfont,
  ...
  keepspaces=true,
  language=C++,
  % Class 0: control flow and built-in keywords
  classoffset=0,
  morekeywords={for, return, const, if, while, int, double,
                size_t, override, true, false, void, else,
                public, private, virtual, class, namespace,
                new, delete, throw, try, catch, static},
  keywordstyle=\bfseries\color{codekw},
  % Class 1: FastJet and STL types
  classoffset=1,
  morekeywords={PseudoJet, ClusterSequence, NNH, DISBriefJet,
                DISjetInfo, DISGenktPlugin, JetDefinition,
                Plugin, FASTJET_BEGIN_NAMESPACE,
                FASTJET_END_NAMESPACE, std, vector, string,
                ostringstream},
  keywordstyle=\color{codetype},
  classoffset=0,
}
