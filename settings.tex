...
\definecolor{codebg}{HTML}{F0F4F8}       % very light blue-gray background
\definecolor{codeframe}{HTML}{C9D6E3}    % soft blue-gray frame
\definecolor{codekw}{HTML}{2A6496}       % muted navy blue - keywords
\definecolor{codecomment}{HTML}{8FA8C8}  % soft mid blue - comments
\definecolor{codestring}{HTML}{3D8A6E}   % muted teal - strings (not jarring green)
\definecolor{codenumber}{HTML}{A0B4C8}   % light blue-gray - line numbers
\definecolor{codeident}{HTML}{2C3E50}    % dark navy - main text (not pure black)
